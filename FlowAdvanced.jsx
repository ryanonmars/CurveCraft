    ...
    function FlowAdvancedPanel(thisObj) {
        ...
        function applyEasing() {
            ...
            try {
                ...
                for (var li = 0; li < selectedLayers.length; li++) {
                    ...
                    for (var ti = 0; ti < targets.length; ti++) {
                        ...
                        for (var k = 1; k <= property.numKeys; k++) {
                            ...
                            // Get the time range for this keyframe
                            var keyTime = property.keyTime(k);
                            
                            // Set temporal ease based on cubic-bezier values
                            // Convert cubic-bezier control points to After Effects ease influence
                            var influence = 33.33; // Default influence percentage
                            ...
                            for (var d = 0; d < numDims; d++) {
                                ...
                                // Y values control the speed/ease
                                var inSpeed = currentValues[1] * 100; // y1
                                var outSpeed = (1 - currentValues[3]) * 100; // inverse of y2
                                
                                // X values control the influence/timing
                                var inInfluence = currentValues[0] * 100; // x1
                                var outInfluence = (1 - currentValues[2]) * 100; // inverse of x2
                ...
                if (appliedCount > 0) {
                    alert("Easing applied to " + appliedCount + " properties! Check the graph editor to see the curves.");
                } else {
